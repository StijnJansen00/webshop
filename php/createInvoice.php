...
// Page header
    ...
    {
        // Logo
        $this->Image('img/logoo4y.png', 22, 15, 63, '', 'PNG');
        // Info
...
// Set Info further of the side
    $pdf->SetX(20);
// Company Info
    $pdf->Cell(15, 5, 'Bedrijf: ' . $companyName, 0, 2, 'L');
    $pdf->Cell(15, 5, $name, 0, 2, 'L');
...
// Set Info further of the side
    $pdf->SetX(20);
// Dear Client
    $pdf->Cell(15, 5, 'Beste ' . $name . ',', 0, 0, 'L');
// Line break
    $pdf->Ln(8);
// Set Info further of the side
    $pdf->SetX(20);
...
// Set Info further of the side
    $pdf->SetX(20);
// Text
    $pdf->MultiCell(160, 5, 'Heeft u een vraag? Neem dan contact met ons op via office4you.nl of bel ons op 055 - 204 0808', 0, 'L', 0);
// Line break
    $pdf->Ln(8);
// Set Info further of the side
    $pdf->SetX(20);
...
// Set Info further of the side
    $pdf->SetX(20);
// Text
    $pdf->MultiCell(160, 5, 'Klantenservice Office4You', 0, 'L', 0);
