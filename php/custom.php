...
$subject = 'Office Op Maat 4YouOffice';
...
//mail("bart@hr4you.nl", $info, $text2, $headers);
//TODO: PERSOONLIJKE MAIL VAN STIJN, LATER WEGHALEN
mail($info[2], $subject, $text2, $headers);
