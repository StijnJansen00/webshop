...
$text = "<p>Beste meneer/mevrouw, </p>";
$text .= "<br><p>U heeft een nieuw wachtwoord opgevraagd</p>";
$text .= "<br><p>Uw nieuwe wachtwoord is: " . $password . "</p>";
$text .= "<br><p>Klik<a class='black' href='https://4youoffice.nl/login'> hier </a>om te inloggen.</p>";
